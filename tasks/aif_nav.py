...
def import_aif_nav_file(input_file_path, output_file_path, user_id):
...
if __name__ == '__main__':
    USER_ID = 1
    FILE_PATH = "samples/AIF - NAV Testing.csv"
    READ_PATH = "read/AIF - NAV Testing.csv"
    import_aif_nav_file(FILE_PATH, READ_PATH, USER_ID)